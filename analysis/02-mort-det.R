...
load(file.path("..","..","..", "compute1","data","raw_all_det_mort.Rdata"))
...
write.csv(mort_det, file.path("..","..","..", "compute1","data", "all_det_mort.csv"))
#write.csv(mort_det, file.path("..", "data","all_det_mort.csv"))
save(mort_det, file = file.path("..","..","..", "compute1","data","all_det_mort.Rdata"))
